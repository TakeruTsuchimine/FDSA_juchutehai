...
<div class="flex-box flex-column" style="padding:5px 10px;">
    <div class="form-column">
        ...
        <label>
            ...
            <input name="dataShiftCd" class="form-control code-check" type="text" maxlength="1" autocomplete="off"
                style="width:8em;" pattern="^([A-G]{1})$" title="{{ __('A～Gのうちから1つを入力してください') }}" required>
        </label>
    </div>
    <div class="form-column">
        <!-- 「シフト名」 -->
    ...
    <div class="form-column">
        <!-- 「指定範囲経過時間（通常勤務）」 -->
        <label>
            <span style="width:14em; margin-right:5px;">{{__('keika_jikan_tsujou')}}</span>
            <!-- コード検査を行う項目は、スタイルクラス「code-check」を宣言 -->
    ...
    <div class="form-column">
        <!-- 「指定範囲経過時間（残業分）」 -->
        <label>
            <span style="width:14em; margin-right:5px;">{{__('keika_jikan_zangyou')}}</span>
            <!-- コード検査を行う項目は、スタイルクラス「code-check」を宣言 -->
...
<script>
    ...
    $('#frmNyuryoku').submit(function(event)
    {
        ...
        function IsChangeNyuryokuData(nyuryokuData)
        {
            ...
            /* 「開始時刻」 */
            if((nyuryokuData['dataStartJikoku'].value != data['dataStartJikoku']) &&
              !(nyuryokuData['dataStartJikoku'].value == '' && data['dataStartJikoku'] == null)) return true;
            /* 「終了時刻（通常勤務）」 */
            if((nyuryokuData['dataEndJikokuTsujou'].value != data['dataEndJikokuTsujou']) &&
              !(nyuryokuData['dataEndJikokuTsujou'].value == '' && data['dataEndJikokuTsujou'] == null)) return true;
            /* 「終了時刻（残業）」 */
            if((nyuryokuData['dataEndJikokuZangyou'].value != data['dataEndJikokuZangyou']) &&
              !(nyuryokuData['dataEndJikokuZangyou'].value == '' && data['dataEndJikokuZangyou'] == null)) return true;
            /* 「指定範囲経過時間（通常勤務）」 */
            if((nyuryokuData['dataKeikaJikanTsujou'].value != data['dataKeikaJikanTsujou']) &&
              !(nyuryokuData['dataKeikaJikanTsujou'].value == '' && data['dataKeikaJikanTsujou'] == null)) return true;
            /* 「指定範囲経過時間（残業分）」 */
            if((nyuryokuData['dataKeikaJikanZangyou'].value != data['dataKeikaJikanZangyou']) &&
              !(nyuryokuData['dataKeikaJikanZangyou'].value == '' && data['dataKeikaJikanZangyou'] == null)) return true;
            /* 「有効期間（自）」 */
