...
class PCINQ_1300 extends Controller
{
    public function index(Request $request)
    {
        ...
        $resultFlg = true;
        // 検索対象テーブル
        $targetTable = 'kaisou_bunrui_master';
        // 対象CD列
        $targetRowCd = 'bunrui_cd';
        // 対象名称列
        $targetRowName = 'bunrui_name';
        ...
        try {
            ...
            if (!is_null($request->dataTargetCd)) {
                // SQL条件文追加
                $SQLBodyText .= " and bunrui_category_cd = :target_cd ";
                // バインドの設定
