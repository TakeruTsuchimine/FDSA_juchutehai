...
class PCINQ_1900 extends Controller
{
    public function index(Request $request)
    {
        ...
        $resultFlg = true;
        // 検索対象テーブル
        $targetTable = 'gaichu_kouho_master';
        // 対象CD列
        $targetRowCd = 'waritukekouho_cd';
        // 対象名称列
        $targetRowName = 'waritukekouho_name';
        ...
        try
        {
            ...
            if (!is_null($request->dataTargetCd)) {
                // SQL条件文追加
                $SQLBodyText .= " and seikyu_cd <> :target_cd ";
                // バインドの設定
