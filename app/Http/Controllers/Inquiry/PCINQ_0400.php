...
class PCINQ_0400 extends Controller
{
    public function index(Request $request)
    {
        ...
        $resultFlg = true;
        // 検索対象テーブル
        $targetTable = 'tantousha_master';
        // 対象CD列
        $targetRowCd = 'tantousha_cd';
        // 対象名称列
        $targetRowName = 'tantousha_name';
        ...
        try {
            ...
            if (!is_null($request->dataTargetCd)) {
                // SQL条件文追加
                $SQLBodyText .= " and tantousha_cd <> :target_cd ";
                // バインドの設定
