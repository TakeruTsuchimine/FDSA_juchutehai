...
class PCINQ_1600 extends Controller
{
    public function index(Request $request)
    {
        ...
        $resultFlg = true;
        // 検索対象テーブル
        $targetTable = 'tokui_nounyusaki_master';
        // 対象CD列
        $targetRowCd = 'nounyusaki_cd';
        // 対象名称列
        $targetRowName = 'nounyusaki_name1';
        ...
        try {
            ...
            if (!is_null($request->dataTargetCd)) {
                // SQL条件文追加
                $SQLBodyText .= " and tokuisaki_cd = :target_cd ";
                // バインドの設定
