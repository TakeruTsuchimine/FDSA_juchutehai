    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            select j.id
                ...
                ,jt.seisaku_kbn
                ,j.tokuisaki_cd
				,t.tokuisaki_ryaku as tokuisaki_name
            ...
            if ($cntFlg) {
                ...
                foreach ($result as $value) {
                    ...
                    $dataArray = $dataArray + array('dataKibouNoukiDate' => $value['nouki_date']);
                    ...
                    $dataArray = $dataArray + array('dataTehaiQty' => (double)$value['tehai_qty']);
                    ...
                    $dataArray = $dataArray + array('dataSeisakuKbn' => $value['seisaku_kbn']);
                    $dataArray = $dataArray + array('dataMatomeKbn' => $value['matome_kbn']);
                    $dataArray = $dataArray + array('dataZumenNo' => $value['zumen_no']);
